  ...
  return (
    <div className="  w-full px-12 mt-4">
      ...
      <div className=" relative w-full h-[400px] mt-8 ">
        ...
        />
        <div className="absolute right-45 top-2/5 transform -translate-y-1/2 w-[25%] border bg-gray-900 rounded-xl opacity-75 text-white p-4 flex flex-col items-end text-left">
