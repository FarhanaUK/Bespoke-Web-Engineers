    ...
    <div className="  w-full px-12 mt-4">
      ...
      <div className=" relative w-full h-[400px] mt-8 ">
        <img
          src="/public/S1.svg"
          alt="Background"
          className="absolute right-0 opacity-85 top-0 h-full object-contain w-[55%]"
        />
        <div className="absolute right-0 top-2/5 transform -translate-y-1/2 transform -translate-x-46 w-[25%] border bg-gray-900 rounded-xl opacity-85 text-white p-4 flex flex-col items-end justify-center text-black text-left border px-4">

          <h2 className="text-2xl font-bold">We Build Beautiful Websites</h2>
          <p className="mt-2 ">Custom coded to perfectly match <br/>your brand identity and business objectives.<br/> Every line of code is carefully<br/> crafted for optimal performance<br/> and user experience.</p>
        </div>
        
      
          <img src="S2.svg"
           alt="Background"
           className="absolute left-35 top-0 h-full object-contain w-[30%] mt-20 opacity-85"/>
