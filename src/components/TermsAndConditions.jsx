function TermsAndConditions() {
    ...
    return (
        <div className="max-w-3xl mx-auto p-6">
          ...
          <h2 className="text-2xl font-semibold mt-4">1. Services</h2>
          <p>
          ...
          <h2 className="text-2xl font-semibold mt-4">2. Pricing and Payment</h2>
          <p>
          ...
          <h2 className="text-2xl font-semibold mt-4">3. Ownership</h2>
          <p>
          ...
          <h2 className="text-2xl font-semibold mt-4">5. Monthly Maintenance</h2>
          <p>
          ...
          <h2 className="text-2xl font-semibold mt-4">6. SEO and Website Performance</h2>
          <p>
          ...
          <h2 className="text-2xl font-semibold mt-4">7. Liability</h2>
          <p>
          ...
          <h2 className="text-2xl font-semibold mt-4">8. Support and Maintenance</h2>
          <p>
          ...
          <h2 className="text-2xl font-semibold mt-4">9. Subcontracting</h2>
          <p>
